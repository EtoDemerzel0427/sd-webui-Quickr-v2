...
def on_ui_tabs():
                ...
                with gr.Row():
                    ...
                    with gr.Column(variant='panel'):
                        with gr.Column(scale=1):
                            with gr.Group():
                                debug_info = gr.HTML(elem_id="ebs_info_area", value="Select Stage and Click 'Generate' to run each stage.")
                            ...
                            with gr.Column(scale=2):
                                ...
                                gr.HTML(value="<p style='margin-bottom: 0.7em'>\
                                                ...
                                                <b>stage 1</b> <br>\
                                                    ...
                                                    Generate a mask image (Using CLIPseg etc.). <br><br>\
                                                <b>stage 2</b> <br>\
                                                    Select keyframes to be given to FSPBT.<br><br>\
                                                <b>stage 3</b> <br>\
                                                    img2img keyframes (Go to the img2img tab, select FSPBT script). <br><br>\
                                                <b>stage 3.5</b> <br>\
    ...
    return (ebs_interface, "Quickr", "ebs_interface"),
