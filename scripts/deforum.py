...
for basedir in basedirs:
    deforum_paths_to_ensure = [basedir + '/extensions/sd-webui-Quickr-v2/scripts', basedir + '/extensions/sd-webui-controlnet', basedir + '/extensions/deforum/scripts', basedir + '/scripts/deforum_helpers/src', basedir + '/extensions/deforum/scripts/deforum_helpers/src', basedir +'/extensions/sd-webui-Quickr-v2/scripts/deforum_helpers/src',basedir]
    ...
    for i in range(times_to_run):
        ...
        if video_args.skip_video_creation:
            ...
            try:
                ...
                deforum_args.i1_store = f'<p style=\"font-weight:bold;margin-bottom:0em\">Quickr extension for auto1111 — version 2.2b </p><video controls loop><source src="{data_url}" type="video/mp4"></video>'
